...
- Weighting content downloads too heavily (research does not equal buying intent)
- Not including negative scoring (lets bad leads through)
- Setting and forgetting (buyer behavior changes; recalibrate quarterly)
- Scoring all page visits equally (pricing page does not equal blog post)
...
- **Merge priority** — CRM record wins over marketing automation; most recent activity wins
